            ...
            <div className="w-full max-w-md mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
              ...
              <div className="p-8 pt-10">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        name="username-no-autofill" // Use a non-standard name
                      />
                    </div>
                    <div
                      id="uidnote"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        name="email-no-autofill" // Use a non-standard name
                      />
                    </div>
                    <div
                      id="emailnote"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        name="password-no-autofill" // Use a non-standard name
                      />
                      <button
                        type="button"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        name="confirm-password-no-autofill" // Use a non-standard name
                      />
                      <button
                        type="button"
                        className="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-500"
                  ...
                  {/* Hidden field to prevent autofill - acts as a honeypot */}
